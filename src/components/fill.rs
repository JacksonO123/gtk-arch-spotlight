...
use crate::app_state;
use crate::components::result_list::ListHandles;
...
pub fn create_element(
    ...
    let (window_content_element, handles) = window_content::create_element(the_app_state, config);

    fill.append(&window_content_element);

    (fill, window_content_element, handles)
}
